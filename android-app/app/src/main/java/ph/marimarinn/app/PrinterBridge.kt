...
class PrinterBridge {
    ...
    fun kickDrawer(): String {
        return runOnPrinterThread {
            ...
            write(byteArrayOf(0x1B, 0x40, 0x1B, 0x4D, 0x00))
            write(byteArrayOf(0x1B, 0x70, 0x01, 0x3C, 0x78, 0x1B, 0x70, 0x00, 0x3C, 0x78))
            write(byteArrayOf(0x10, 0x14, 0x01, 0x01, 0x01, 0x10, 0x14, 0x01, 0x00, 0x01))
            write(byteArrayOf(0x0A, 0x0A, 0x1D, 0x56, 0x42, 0x00))
            Thread.sleep(800)
            "ok"
        }
    }
